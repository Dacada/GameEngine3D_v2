#include <engine3D_forwardSpot.h>
#include <engine3D_shader.h>
#include <Base/engine3D_util.h>

static engine3D_forwardSpot_t instance;
...
static void updateUniforms(engine3D_shader_t * const s, const engine3D_transform_t *const transform, const engine3D_camera_t *const camera, const engine3D_material_t *const material) {
  engine3D_forwardSpot_t *shader = (engine3D_forwardSpot_t*)s;
  ...
  engine3D_shader_setUniformSpotLight("spotLight", shader->spotLight, s);
}
...
engine3D_forwardSpot_t *engine3D_forwardSpot_getInstance(void) {
  if (!isLoaded) {
    ...
    engine3D_shader_addVertexShaderFromFile("forward-spot.vs", (engine3D_shader_t*)&instance);
    engine3D_shader_addFragmentShaderFromFile("forward-spot.fs", (engine3D_shader_t*)&instance);
    ...
    engine3D_shader_addUniform("spotLight.pointLight.base.color", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.pointLight.base.intensity", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.pointLight.atten.constant", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.pointLight.atten.linear", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.pointLight.atten.exponent", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.pointLight.position", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.pointLight.range", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.direction", (engine3D_shader_t*)&instance);
    engine3D_shader_addUniform("spotLight.cutoff", (engine3D_shader_t*)&instance);
